...
@Slf4j
public class UploadBlenderOrderListener implements ReadListener<BlenderOrder> {
    /**
     * 每隔5条存储数据库，实际使用中可以100条，然后清理list ，方便内存回收
     */
    private static final int BATCH_COUNT = 100;
    private List<BlenderOrder> cachedDataList = ListUtils.newArrayListWithExpectedSize(BATCH_COUNT);
    /**
    ...
    private void saveData() {
        ...
        uploadDAO.insertBatch(cachedDataList);
        log.info("存储数据库成功！");
    }
}
